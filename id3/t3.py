...
#    print attributes
    new_attributes = [attributes[0], attributes[1], attributes[3],attributes[4], attributes[5], attributes[6],attributes[10]]
#    print new_attributes
    ...
    tree = create_decision_tree(get_data(csv_file_object, new_attributes, [0,1,3,4,5,6,10]), new_attributes, target_attr, gain)
...
#    target_attr = attributes[0]
    ...
    classification = classify(tree, get_test_data(csv_file_object,new_attributes, [0,2,3,4,5,9]))
